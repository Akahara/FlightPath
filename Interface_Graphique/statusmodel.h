...
class StationStatusModel : public QAbstractTableModel
{
    QMap<std::string, bool> m_statuses;
public:
    StationStatusModel(QObject * parent = {}) : QAbstractTableModel{parent} {}
    ...
    bool isExcluded(const Station &station) {
        return !m_statuses[station.getStatus()];
    }
